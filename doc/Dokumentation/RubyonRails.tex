...
% Formatierung für Code-Listings setzen:
...
\newcommand{\titel}{Konzeption und Entwicklung einer CD-Tauschbörse mit \\Ruby on Rails}
\newcommand{\untertitel}{\empty}
\newcommand{\autor}{Christian Bunk \\ Alexander Miller \\ Christian Sandvoß \\ Antonia Ziegler}
...
\include{chapter/Kapitel1_Einleitung}
\include{chapter/Erfahrungen}
\include{chapter/RubyProjektmanagement}
\include{chapter/DatenbasisFunktionalität}
\include{chapter/FileUpload}
\include{chapter/MusicBrainz}
\include{chapter/Tests}
\include{chapter/Kapitel6_Fazit}
\include{chapter/Anhang}
%\input{chapter/ZZ2_Abschluss.tex}
